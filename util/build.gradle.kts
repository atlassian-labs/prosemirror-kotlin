...
ext.set("pomUrl", "https://github.com/atlassian-labs/prosemirror-kotlin/tree/util/")
ext.set("dokkaUrlPrefix", "https://github.com/atlassian-labs/prosemirror-kotlin/util/")
