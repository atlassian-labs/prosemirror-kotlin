...
// TODO EASY convert remaining tests to Kotlin
...
//     });
//     @Test TODO
//     fun `supports JSON_stringify toJSON arguments`() {
//         val someObject = mapOf("someKey" to EditorState.create(EditorStateConfigImpl(schema = schema)))
//         assertTrue(JSON.encodeToString(someObject).isNotEmpty());
//     }
// });
// describe("Plugin", () => {
