...
// fun <T: Function> bind(f: T?, self: Any?): T? {
//     return if (self == null || f == null) f else f.bind(self)
// }
...
internal class EmptyEditorStateConfig(
...
//             ;(instance as any)[name] = this.hasOwnProperty(name) ? (this as any)[name] :
