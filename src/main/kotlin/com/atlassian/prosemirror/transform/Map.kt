...
//         let start = this.ranges[i], oldStart = start - (this.inverted ? diff : 0),
...
class StepMap(
    ...
    override fun mapResult(pos: Int, assoc: Int): MapResult { return this._map(pos, assoc, false) as MapResult
    }

    override fun map(pos: Int, assoc: Int): Int { return _map(pos, assoc, true) as Int }
...
class Mapping(
  ...
  var to: Int = maps.size
    ...
    internal fun setMirror(n: Int, m: Int) {
