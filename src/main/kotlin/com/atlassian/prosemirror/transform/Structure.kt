...
//                 throw new RangeError("Wrapper type given to Transform.wrap does not form valid content of its parent
//                      wrapper")
//         }
...
// export function split(tr: Transform, pos: number, depth = 1, typesAfter?:
//  (null | {type: NodeType, attrs?: Attrs | null})[]) {
