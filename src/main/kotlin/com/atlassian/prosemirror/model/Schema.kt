...
//     return built
// }
// computeAttrs not needed anymore - for correct round trip we don't combine attributes
// on creation
...
//     /// if it doesn't match.
//     createChecked(attrs: Attrs | null = null, content?: Fragment | Node | readonly Node[] | null, marks?:
//          readonly Mark[]) {
...
//     createAndFill(attrs: Attrs | null = null, content?: Fragment | Node | readonly Node[] | null, marks?:
//          readonly Mark[]) {
...
//
//     /// @internal
//     static compile<Nodes extends string>(nodes: OrderedMap<NodeSpec>, schema: Schema<Nodes>):
