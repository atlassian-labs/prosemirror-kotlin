    ...
    dokkaSourceSets {
      val commonMain by getting {
        sourceLink {
          ...
          remoteUrl.set(URL("https://github.com/atlassian-labs/prosemirror-kotlin/transform/src/main/src/commonMain/kotlin"))
      ...
      val jvmMain by getting {
        sourceLink {
          ...
          // URL showing where the source code can be accessed through the web browser
          remoteUrl.set(URL("https://github.com/atlassian-labs/prosemirror-kotlin/transform/src/main/src/jvmMain/kotlin"))
      ...
      val nativeMain by getting {
        sourceLink {
          ...
          // URL showing where the source code can be accessed through the web browser
          remoteUrl.set(URL("https://github.com/atlassian-labs/prosemirror-kotlin/transform/src/main/src/nativeMain/kotlin/"))
  ...
  publications {
    publications.withType<MavenPublication> {
      pom {
        ...
        description.set("ProseMirror document transformations")
        url.set("https://github.com/atlassian-labs/prosemirror-kotlin/tree/transform/")
